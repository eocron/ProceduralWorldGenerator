...
namespace ProceduralWorldGenerator.Common.Controls
{
    ...
    public class TabControlEx : TabControl
    {
        ...
        public static readonly DependencyProperty AddTabCommandProperty =
            DependencyProperty.Register(nameof(AddTabCommand), typeof(ICommand), typeof(TabControlEx),
                new PropertyMetadata(null));

        public static readonly DependencyProperty AutoScrollToEndProperty =
            DependencyProperty.Register(nameof(AutoScrollToEnd), typeof(bool), typeof(TabControlEx),
